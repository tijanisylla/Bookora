          ...
          <div className="grid md:grid-cols-2">
              ...
              <div>
                ...
                <ul className="mt-6 space-y-3 text-sm text-blue-100">
                  <li className="flex gap-2">
                    <CheckBullet />
                    Save favorite listings and pick up where you left off
                  </li>
                  <li className="flex gap-2">
                    <CheckBullet />
                    Get tailored recommendations from local experts
                  </li>
                  <li className="flex gap-2">
                    <CheckBullet />
                    Secure access to tours and new inventory
                  </li>
                </ul>
              </div>
            ...
            <div className="p-8 sm:p-10">
              ...
              {searchParams.get("registered") === "1" && (
                <p
                  className="mt-4 rounded-lg bg-emerald-50 px-3 py-2 text-sm text-emerald-800 ring-1 ring-emerald-100"
                  role="status"
                >
              ...
              >
                ...
                <div className="flex justify-end">
                  <Link
                    to={`/forgot-password${username ? `?email=${encodeURIComponent(username)}` : ""}`}
